...
export class HandlerCombiner {
    ...
    constructor() {
        ...
        this.btn.set(DifficultBtn.btnName, new DifficultBtn(this.toggleBtnName, this.updateUserStat));
        ...
        this.btn.set(RestoreBtn.btnName, new RestoreBtn(this.toggleBtnName, this.updateUserStat));
    }
